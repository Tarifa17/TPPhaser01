class EscenaHorizontal extends Phaser.Scene {
    ...
    preload() {
        ...
        this.load.image('naveEnemiga', '/public/resources/boss.png');
    ...
    create() {
        ...
        this.grupoNaveEnemiga = this.physics.add.group();
        ...
        this.physics.add.collider(this.jugador, this.grupoNaveEnemiga, this.destruirNaveEnemiga, null, this);
        ...
        // Generar navesEnemigas 
        this.time.addEvent({
        delay: 1000,
        callback: this.generarNaveEnemiga,
        callbackScope: this,
        loop: true,
        });
    ...
    generarEnemigosNave() {
        ...
        const naveEnemiga = this.grupoNaveEnemiga.create(800, y, "naveEnemiga");
        naveEnemiga.setVelocityX(-150);
        naveEnemiga.vidas = 3;
    }

    destruirNaveEnemiga(proyectil, naveEnemiga) {
        proyectil.destroy(); // Destruye el proyectil
        naveEnemiga.destroy(); // Destruye el meteoro
        this.sound.play('explosion');
        this.puntaje += 400; // Aumenta el puntaje o realiza cualquier otra acción que desees
        this.textoPuntaje.setText('Puntaje: ' + this.puntaje); // Actualiza el puntaje en pantalla
    }
